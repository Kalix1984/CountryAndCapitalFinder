...
import stylesCss from 'themes/countryapp/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/countryapp/components/vaadin-button.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_countryapp_componentCss']) {
    registerStyles(
      'vaadin-button',
      unsafeCSS(vaadinButtonCss.toString())
    );
    
    document['_vaadintheme_countryapp_componentCss'] = true;
  }
